...
public class CreateNewProductsProcessor implements RequestProcessor {
    private static final Logger createNewProductsLogger = LogManager.getLogger(CreateNewProductsProcessor.class.getName());
    ...
    public void execute(HttpRequest httpRequest, OutputStream output) throws IOException {
        ...
        Storage.safe(item);
        createNewProductsLogger.trace("Удаленно создан товар {}, id: {}, цена: {}", item.getTitle(), item.getId(), item.getPrice());
